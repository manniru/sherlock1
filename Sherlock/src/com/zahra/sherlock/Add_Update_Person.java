...
public class Add_Update_Person extends Activity {
	...
	if (called_from.equalsIgnoreCase("add")) {
	    ...
	    Person c = dbHandler.Get_Person(USER_ID);
	...
	add_save_btn.setOnClickListener(new View.OnClickListener() {
		...
		if (valid_name != null && valid_gender != null && valid_height!= null && valid_age != null
		    ...
		    dbHandler.Add_Person(new Person(valid_name,
			    valid_age, valid_email, valid_gender, valid_height, valid_haircolor, valid_comment));
		    Toast_msg = "Data inserted successfully";
		    Show_Toast(Toast_msg);
		    Reset_Text();
		    
			Intent view_user = new Intent(Add_Update_Person.this, Main.class);
	...
	update_btn.setOnClickListener(new View.OnClickListener() {
		...
		if (valid_name != null && valid_gender != null && valid_height!= null && valid_age != null
		    ...
		    dbHandler.Update_Person(new Person(USER_ID, valid_name,
			    valid_age, valid_email, valid_gender, valid_height, valid_haircolor, valid_comment));
		    dbHandler.close();
